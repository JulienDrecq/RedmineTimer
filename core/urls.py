...
urlpatterns = patterns('',
    ...
    url(r'^timer/(?P<timer_id>\d+)/entry/(?P<entry_id>\d+)/delete', 'core.views.delete_entry',
        name='core_delete_entry'),
    url(r'^timer/(?P<timer_id>\d+)/entry/(?P<entry_id>\d+)/upload', 'core.views.upload_entry',
        name='core_upload_entry'),
    url(r'^timer/(?P<timer_id>\d+)/add_timer/', 'core.views.add_timer', name='core_add_timer'),
)